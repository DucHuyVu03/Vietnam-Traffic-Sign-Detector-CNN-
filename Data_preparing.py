...
for labels_dir, image_dir in zip(label_folder.iterdir(), img_folder.iterdir()):
    ...
    with open(labels_dir, 'r') as file:
        ...
        for line in lines:
            ...
            save_path_128x128 = save_folder_128x128/ f"{sign_th}_{classes[int(coor[0])]}.jpg"
